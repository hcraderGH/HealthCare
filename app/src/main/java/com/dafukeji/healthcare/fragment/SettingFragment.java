...
import com.dafukeji.healthcare.ui.AboutSoftwareActivity;
...
public class SettingFragment extends Fragment implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
	...
	private void initViews() {
		...
		llNoDisturbing = (LinearLayout) mView.findViewById(R.id.ll_no_disturbing);

		btnExit = (Button) mView.findViewById(R.id.btn_exit);
		btnExit.setOnClickListener(this);

		tvVersionInfo = (TextView) mView.findViewById(R.id.tv_version_info);
		...
		mrlCheckUpdate = (MaterialRippleLayout) mView.findViewById(R.id.rv_check_update);
		mrlCheckUpdate.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (NetworkUtils.isConnected()) {
					...
					ToastUtil.showToast(getActivity(), "网络已断开!", 1000);
				}
			}
		});

		mrlClearDb = (MaterialRippleLayout) mView.findViewById(R.id.rv_clear_database);
				...
				AlertDialog.Builder builder = new AlertDialog.Builder(getActivity())
						...
						.setPositiveButton("确定", new DialogInterface.OnClickListener() {
							...
							public void onClick(DialogInterface dialog, int which) {
								DataCleanManager.cleanDatabaseByName(getActivity(), Constants.CURE_DB_NAME);
								dialog.dismiss();
								ToastUtil.showToast(getActivity(), "已清空本地数据库", 1000);
							}
						})
		...
		mrlAboutSoftware = (MaterialRippleLayout) mView.findViewById(R.id.rv_about_software);
				...
				if (isChecked) {
					mPushAgent.enable(new IUmengCallback() {
						...
						public void onSuccess() {
							ToastUtil.showToast(getActivity(), "开启消息推送功能", 1000);
						}
					...
					mPushAgent.disable(new IUmengCallback() {
						@Override
						public void onSuccess() {
							ToastUtil.showToast(getActivity(), "关闭消息推送功能", 1000);
						}
