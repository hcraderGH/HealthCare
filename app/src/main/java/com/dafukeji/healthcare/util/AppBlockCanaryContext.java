...
import com.dafukeji.healthcare.BuildConfig;
...
/**
 * Created by DevCheng on 2017/6/14.
 */
...
public class AppBlockCanaryContext extends BlockCanaryContext {
	...
	public String provideQualifier() {
		...
		try {
			...
			qualifier+=info.versionCode+"_"+info.versionName+"_DEVCHENG";
